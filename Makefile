...
export TERRAFORM_PROVIDER_VERSION := 1.10.2-crossplane
...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://github.com/helderjs/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
