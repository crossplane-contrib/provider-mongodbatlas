# MongoDBAtlas Provider [![v1.5.0](https://img.shields.io/badge/v1.5.0-green)](https://github.com/crossplane-contrib/provider-mongodbatlas/releases/tag/v1.5.0)
...
spec:
  package: xpkg.upbound.io/crossplane-contrib/provider-mongodbatlas:v1.5.0
EOF
```
