...
// GetInitParameters of this ListAPIKey
func (tr *ListAPIKey) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ListAPIKey
func (tr *ListAPIKey) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
