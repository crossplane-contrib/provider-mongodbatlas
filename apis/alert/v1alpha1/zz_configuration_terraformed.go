...
func (tr *Configuration) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"notification[*].api_token": "notification[*].apiTokenSecretRef", "notification[*].datadog_api_key": "notification[*].datadogApiKeySecretRef", "notification[*].flowdock_api_token": "notification[*].flowdockApiTokenSecretRef", "notification[*].microsoft_teams_webhook_url": "notification[*].microsoftTeamsWebhookUrlSecretRef", "notification[*].ops_genie_api_key": "notification[*].opsGenieApiKeySecretRef", "notification[*].service_key": "notification[*].serviceKeySecretRef", "notification[*].victor_ops_api_key": "notification[*].victorOpsApiKeySecretRef", "notification[*].victor_ops_routing_key": "notification[*].victorOpsRoutingKeySecretRef", "notification[*].webhook_secret": "notification[*].webhookSecretSecretRef", "notification[*].webhook_url": "notification[*].webhookUrlSecretRef"}
}
