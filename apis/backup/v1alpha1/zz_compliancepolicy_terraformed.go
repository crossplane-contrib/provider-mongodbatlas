...
// GetInitParameters of this CompliancePolicy
func (tr *CompliancePolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this CompliancePolicy
func (tr *CompliancePolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
