...
// GetInitParameters of this BackupSnapshot
func (tr *BackupSnapshot) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BackupSnapshot
func (tr *BackupSnapshot) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
