...
// GetInitParameters of this BackupSnapshotExportBucket
func (tr *BackupSnapshotExportBucket) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BackupSnapshotExportBucket
func (tr *BackupSnapshotExportBucket) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
