...
// GetInitParameters of this BackupSnapshotExportJob
func (tr *BackupSnapshotExportJob) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BackupSnapshotExportJob
func (tr *BackupSnapshotExportJob) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
