...
// GetInitParameters of this BackupSnapshotRestoreJob
func (tr *BackupSnapshotRestoreJob) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BackupSnapshotRestoreJob
func (tr *BackupSnapshotRestoreJob) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
