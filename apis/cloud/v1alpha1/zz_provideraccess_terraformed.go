...
// GetInitParameters of this ProviderAccess
func (tr *ProviderAccess) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ProviderAccess
func (tr *ProviderAccess) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
