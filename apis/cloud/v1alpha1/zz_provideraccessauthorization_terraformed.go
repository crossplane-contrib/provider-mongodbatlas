...
// GetInitParameters of this ProviderAccessAuthorization
func (tr *ProviderAccessAuthorization) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ProviderAccessAuthorization
func (tr *ProviderAccessAuthorization) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
