...
// GetInitParameters of this ProviderAccessSetup
func (tr *ProviderAccessSetup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ProviderAccessSetup
func (tr *ProviderAccessSetup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
