...
// GetInitParameters of this ProviderSnapshotRestoreJob
func (tr *ProviderSnapshotRestoreJob) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ProviderSnapshotRestoreJob
func (tr *ProviderSnapshotRestoreJob) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
