...
// ResolveReferences of this ModelAPIKey.
func (mg *ModelAPIKey) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this ModelRateLimit.
func (mg *ModelRateLimit) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
