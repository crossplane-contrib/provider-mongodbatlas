...
// GetInitParameters of this CustomRole
func (tr *CustomRole) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this CustomRole
func (tr *CustomRole) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
