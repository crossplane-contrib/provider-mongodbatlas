...
// ResolveReferences of this AccountProjectAssignment.
func (mg *AccountProjectAssignment) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this AccountSecret.
func (mg *AccountSecret) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
