...
// GetInitParameters of this OutageSimulation
func (tr *OutageSimulation) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this OutageSimulation
func (tr *OutageSimulation) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
