...
// GetInitParameters of this DBRole
func (tr *DBRole) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DBRole
func (tr *DBRole) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
