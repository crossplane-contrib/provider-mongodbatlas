...
// GetInitParameters of this DNSConfigurationClusterAws
func (tr *DNSConfigurationClusterAws) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DNSConfigurationClusterAws
func (tr *DNSConfigurationClusterAws) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
