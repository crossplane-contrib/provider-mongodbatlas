...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DBRoleInitParameters) DeepCopyInto(out *DBRoleInitParameters) {
	*out = *in
	if in.Actions != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DBRoleInitParameters.
func (in *DBRoleInitParameters) DeepCopy() *DBRoleInitParameters {
	if in == nil {
		return nil
	}
	out := new(DBRoleInitParameters)
	in.DeepCopyInto(out)
	return out
}
