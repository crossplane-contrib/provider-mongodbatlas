...
// GetInitParameters of this QueryLimit
func (tr *QueryLimit) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this QueryLimit
func (tr *QueryLimit) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
