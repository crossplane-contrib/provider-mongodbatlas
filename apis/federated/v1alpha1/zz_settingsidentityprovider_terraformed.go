...
// GetInitParameters of this SettingsIdentityProvider
func (tr *SettingsIdentityProvider) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SettingsIdentityProvider
func (tr *SettingsIdentityProvider) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
