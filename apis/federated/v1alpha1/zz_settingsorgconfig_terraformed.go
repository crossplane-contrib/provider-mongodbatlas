...
// GetInitParameters of this SettingsOrgConfig
func (tr *SettingsOrgConfig) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SettingsOrgConfig
func (tr *SettingsOrgConfig) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
