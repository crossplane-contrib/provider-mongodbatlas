...
// GetInitParameters of this SettingsOrgRoleMapping
func (tr *SettingsOrgRoleMapping) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SettingsOrgRoleMapping
func (tr *SettingsOrgRoleMapping) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
