...
type NotificationInitParameters struct {
	...
	DatadogAPIKeySecretRef *v2.LocalSecretKeySelector `json:"datadogApiKeySecretRef,omitempty" tf:"-"`
	...
	OpsGenieAPIKeySecretRef *v2.LocalSecretKeySelector `json:"opsGenieApiKeySecretRef,omitempty" tf:"-"`
	...
	VictorOpsAPIKeySecretRef *v2.LocalSecretKeySelector `json:"victorOpsApiKeySecretRef,omitempty" tf:"-"`

	// VictorOps routing key. Optional for the VICTOR_OPS notifications type. If the key later becomes invalid, Atlas sends an email to the project owner and eventually removes the key.
	VictorOpsRoutingKeySecretRef *v2.LocalSecretKeySelector `json:"victorOpsRoutingKeySecretRef,omitempty" tf:"-"`
	...
	WebhookURLSecretRef *v2.LocalSecretKeySelector `json:"webhookUrlSecretRef,omitempty" tf:"-"`
}
