...
type NotificationInitParameters struct {
	...
	DatadogAPIKeySecretRef *v1.LocalSecretKeySelector `json:"datadogApiKeySecretRef,omitempty" tf:"-"`
	...
	FlowdockAPITokenSecretRef *v1.LocalSecretKeySelector `json:"flowdockApiTokenSecretRef,omitempty" tf:"-"`
	...
	VictorOpsRoutingKeySecretRef *v1.LocalSecretKeySelector `json:"victorOpsRoutingKeySecretRef,omitempty" tf:"-"`

	WebhookSecretSecretRef *v1.LocalSecretKeySelector `json:"webhookSecretSecretRef,omitempty" tf:"-"`

	WebhookURLSecretRef *v1.LocalSecretKeySelector `json:"webhookUrlSecretRef,omitempty" tf:"-"`
}
