...
// ResolveReferences of this EncryptionAtRest.
func (mg *EncryptionAtRest) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this MetricIntegration.
func (mg *MetricIntegration) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
