...
func (mg *Connection) GetTerraformResourceType() string {
	return "mongodbatlas_stream_connection"
}

// GetConnectionDetailsMapping for this Connection
func (tr *Connection) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"authentication.client_secret": "authentication.clientSecretSecretRef", "authentication.password": "authentication.passwordSecretRef", "schema_registry_authentication.password": "schemaRegistryAuthentication.passwordSecretRef"}
}
