...
// GetInitParameters of this EndpointRegionalMode
func (tr *EndpointRegionalMode) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EndpointRegionalMode
func (tr *EndpointRegionalMode) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
