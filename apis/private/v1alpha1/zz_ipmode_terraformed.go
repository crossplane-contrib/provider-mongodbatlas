...
func (mg *IPMode) GetTerraformResourceType() string {
	return "mongodbatlas_private_ip_mode"
}
...
func (tr *IPMode) GetObservation() (map[string]any, error) {
...
func (tr *IPMode) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this IPMode
...
func (tr *IPMode) GetParameters() (map[string]any, error) {
...
func (tr *IPMode) SetParameters(params map[string]any) error {
...
// GetInitParameters of this IPMode
func (tr *IPMode) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IPMode
func (tr *IPMode) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this IPMode using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *IPMode) LateInitialize(attrs []byte) (bool, error) {
	params := &IPModeParameters{}
