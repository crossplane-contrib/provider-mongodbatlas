...
// GetInitParameters of this EndpointServerless
func (tr *EndpointServerless) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EndpointServerless
func (tr *EndpointServerless) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
