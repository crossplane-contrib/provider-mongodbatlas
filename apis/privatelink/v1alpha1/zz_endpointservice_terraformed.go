...
// GetInitParameters of this EndpointService
func (tr *EndpointService) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EndpointService
func (tr *EndpointService) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
