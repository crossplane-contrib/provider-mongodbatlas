...
// GetInitParameters of this EndpointServiceAdl
func (tr *EndpointServiceAdl) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EndpointServiceAdl
func (tr *EndpointServiceAdl) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
