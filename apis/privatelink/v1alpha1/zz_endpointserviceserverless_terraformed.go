...
// GetInitParameters of this EndpointServiceServerless
func (tr *EndpointServiceServerless) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EndpointServiceServerless
func (tr *EndpointServiceServerless) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
