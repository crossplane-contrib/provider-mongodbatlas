...
// GetInitParameters of this AuthenticationDatabaseUser
func (tr *AuthenticationDatabaseUser) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AuthenticationDatabaseUser
func (tr *AuthenticationDatabaseUser) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
