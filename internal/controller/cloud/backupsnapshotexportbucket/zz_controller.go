...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.BackupSnapshotExportBucket_GroupVersionKind),
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["mongodbatlas_cloud_backup_snapshot_export_bucket"],
