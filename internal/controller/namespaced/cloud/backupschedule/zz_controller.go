...
// SetupWebhookWithManager registers the conversion webhook for BackupSchedule.
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	ac := tjcontroller.NewAPICallbacks(mgr, xpresource.ManagedKind(v1alpha1.BackupSchedule_GroupVersionKind), tjcontroller.WithEventHandler(eventHandler), tjcontroller.WithStatusUpdates(false))
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginSDKAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["mongodbatlas_cloud_backup_schedule"],
				...
				tjcontroller.WithTerraformPluginSDKAsyncMetricRecorder(metrics.NewMetricRecorder(v1alpha1.BackupSchedule_GroupVersionKind, mgr, o.PollInterval)),
