...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	for _, i := range o.Provider.Resources["mongodbatlas_ldap_configuration"].InitializerFns {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["mongodbatlas_ldap_configuration"], tjcontroller.WithLogger(o.Logger), tjcontroller.WithConnectorEventHandler(eventHandler),
	...
	// if they're enabled.
	if o.StartWebhooks {
		if err := ctrl.NewWebhookManagedBy(mgr, &v1alpha1.Configuration{}).
			Complete(); err != nil {
